...
const App = () => {
  ...
  return (
    // ✅ 2. Use a React Fragment to wrap everything
    <>
      {/* The 3D background is now a sibling to your main app, not a child. */}
      <ThreeBackground />

      {/* All of your original app content is wrapped in the providers as before. */}
      <GoogleAuthProvider>
        <SettingsProvider>
          <MobileMenuProvider>
            <AlgorithmProvider>
